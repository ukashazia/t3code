...
const buildAppUnderTest = (options?: {
  ...
  layers?: {
    ...
    providerAuthSessionManager?: Partial<
      ProviderAuthSessionManager.ProviderAuthSessionManager["Service"]
    >;
    ...
    const servedRoutesLayer = HttpRouter.serve(
      ...
      Layer.provide(
        Layer.mergeAll(
          ...
          Layer.mock(ProviderAuthSessionManager.ProviderAuthSessionManager)({
            ...options?.layers?.providerAuthSessionManager,
          }),
        ),
      ),
      Layer.provide(
